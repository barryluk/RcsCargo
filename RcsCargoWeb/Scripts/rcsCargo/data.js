...
var indexPages = [
    ...
    {
        pageName: "acReceivable",
        id: "",
        title: "Accounts Receivable",
        initScript: "controllers.accounting.initReceivable",
        targetContainer: {},
        searchControls: [{ label: "Invoice Date", type: "dateRange", name: "invoiceDateRange", daysBefore: 180 }],
        gridConfig: {
            gridName: "gridReceivableIndex",
            dataSourceUrl: "../Accounting/ReceivablePayable/GridReceivablePayable_Read",
            linkIdPrefix: "",
            linkTabTitle: "",
            toolbar: [
                { name: "new", text: "New", iconClass: "k-icon k-i-file-add" },
            ...
            columns: [
                { field: "VOUCH_DATE", title: "Date", template: ({ VOUCH_DATE }) => data.formatDateTime(VOUCH_DATE, "date"), filterable: false },
                { field: "INV_NO", title: "Invoice #", attributes: { "class": "link-cell" }, filterable: false },
                { field: "CUSTOMER_NAME", title: "Customer", filterable: { multi: true, search: true } },
                { field: "AMOUNT", title: "Amount", template: ({ AMOUNT }) => kendo.toString(AMOUNT, "n"), filterable: false },
                { field: "MAWB_NO", title: "MAWB #", filterable: false },
                { field: "FLIGHT_NO", title: "Flight #", filterable: false },
                { field: "FLIGHT_DATE", title: "ETD", template: ({ FLIGHT_DATE }) => data.formatDateTime(FLIGHT_DATE, "date"), filterable: false },
                { field: "ORIGIN", title: "Origin", filterable: { multi: true, search: true } },
                { field: "DEST", title: "Destination", filterable: { multi: true, search: true } },
                { field: "HAWB_NO", title: "HAWB #", filterable: false },
            ],
        },
    },
    {
        ...
        initScript: "controllers.accounting.initPayable",
        targetContainer: {},
        searchControls: [{ label: "Invoice Date", type: "dateRange", name: "invoiceDateRange", daysBefore: 180 }],
        gridConfig: {
            gridName: "gridPayableIndex",
            dataSourceUrl: "../Accounting/ReceivablePayable/GridReceivablePayable_Read",
            linkIdPrefix: "",
            linkTabTitle: "",
            toolbar: [
    ...
    },
    {
        ...
        schema: {
            fields: [
                ...
                { name: "PV_TYPE", required: "true", readonly: "edit" },
                { name: "PV_CATEGORY", required: "true" },
                { name: "VENDOR_INV_NO", required: "true" },
                { name: "CURR_CODE", required: "true", defaultValue: "currency" },
                { name: "CUSTOMER", required: "true" },
                { name: "PACKAGE_UNIT", required: "true" },
                { name: "FRT_PAYMENT_PC", required: "true" },
